            ...
            <div className="p-3">
                <div className="post__top d-flex align-items-center justify-content-between">
                    <div className="post__top-left d-flex align-items-center">
                        <img src={'/assets/' +  (Users.filter(u => u.id === post.userId)[0]?.profilePicture) } alt="image" className="post__image-user"/>
                ...
                <div className="post__center my-3">
                    ...
                    <img src={ '/assets/'+ post?.photo } alt="image" className="post__image"/>
                </div>
                <div className="post__bottom d-flex align-items-center justify-content-between">
                    <div className="post__bottom-left d-flex align-items-center">
                        <img src="/assets/like.png" alt="image" className="post__action-btn" onClick={likeHandler} />
                        <img src="/assets/heart.png" alt="image" className="post__action-btn"/>
